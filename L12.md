...
These are the instructions for the final assessed lab.
...
Your lab session lasts for 100 minutes. You can use all of this time
...
Enter a command to copy the raw disk image from `assessed.img` into

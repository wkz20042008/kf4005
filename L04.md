...
2. If you have not completed the previous exercises, please continue to do that at [Shell Scripting Exercises (1).pdf](https://wkz20042008.github.io/kf4005/assets/ra/Shell Scripting Exercises (1).pdf) 
...
4. Please go through the assessment specification and make sure you understand the requirement.

5. Please continue your previous lab work if you have not completed it, e.g., Week 5 SQL practices. 
...
refer to the lecture slides of week 5 for more
...
1. Write queries for the following
    ...
    1. List all the attributes of the pet with the date of birth 1996-04-29
    1. List the name and species of all the male pets
...
1. Write queries for the following
    ...
    1. List every species and the total weight of pets of that species.
    1. Order the results of previous exercise by total weight.
    1. Rewrite the previous query to show the list in weight order from heaviest to lightest.
...
1. Now write queries to solve the following
    ...
    1. List all the different owners whose pets have had a litter.
...
1. Please contiue your lab work if you have not completed it.

1. (Creating a new user and granting permissions) Work through [Etel Sverdlov's
...
1. Work through the tutorial at [MySQL.com](https://dev.mysql.com/doc/refman/5.7/en/tutorial.html) to fill in the gaps left by these exercises.
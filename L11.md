...
Enter a command to copy the raw disk image from `rtlab1/kf4005/test.img` into
`/home/student/<your_user_id>/kf4005`. Note this file is about 2.5GB and the
download may take a few minutes to complete. If you haven't already done so,
set the current working directory to `/home/student/<you_user_id>/kf4005`
...
`Assessment->Assessed Lab`. Check your submission. Failure to submit

...
1. Copy the following files into the deliverables directory:
    ...
    * `filedata.txt`
    * `sqlout.txt`
1. Create a zip file `deliverables.zip` which includes all the required files, i.e., bashinput.txt bashoutput.txt sqlout.txt filedata.txt disk_analysis.sh. You may try to use

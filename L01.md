...
```sh
$ cd ~/Downloads
$ curl -L -O -J http://releases.ubuntu.com/16.04/ubuntu-16.04.5-desktop-amd64.iso
```
{: .code}
...
3. If you're feeling adventurous, you could also download and install an Ubuntu
   ...
   [http://releases.ubuntu.com/16.04/ubuntu-16.04.5-desktop-amd64.iso](http://releases.ubuntu.com/16.04/ubuntu-16.04.6-desktop-amd64.iso).

...
> You can use **nano**, which some people may find more friendly to new users.

> Please work through the tutorial at [Writing Shell Scripts — The Beginner’s Guide](https://github.com/wkz20042008/kf4005/blob/master/assets/ra/Writing%20Shell%20Scripts%20%E2%80%94%20The%20Beginner%E2%80%99s%20Guide.pdf).


## Have a look at the exercise.

Please click the link [Shell Scripting Exercises (1).pdf](https://github.com/wkz20042008/kf4005/blob/master/assets/ra/Shell%20Scripting%20Exercises%20(1).pdf) 

The solution is here [Shell Scripting Exercises (1) - Solution.pdf](https://github.com/wkz20042008/kf4005/blob/master/assets/ra/Shell%20Scripting%20Exercises%20(1)%20-%20Solution.pdf)
...
Next, please develop your understanding further by reading Chapters 1-6 in [The Linux Command Line]({{site.baseurl}}{{site.raurl}}/TLCL.pdf). Have a command line open
...
-->
## Online session/Further exercises: 

1. Please continue your lab work if you have not completed. 

2. Exercises: Getting some data. Positional parameters contain the parameters from the command line.

3. Recreate the `tidy` script from the lecture slides.
    ```sh
    #!/bin/sh
    cd $1
    mkdir src
...
Work through Shell Script examples (Page 5-26) in the [lecture slides](

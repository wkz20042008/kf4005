...
do is list the partition information, e.g.
     ...
     /dev/sda1  *          2048  772561766 772559719 368.4G 83 Linux
     /dev/sda2        772562942 1250263039 477700098 227.8G  5 Extended
     /dev/sda5       1228443648 1250263039  21819392  10.4G 82 Linux swap / Solaris
     /dev/sda6        772562944 1228443647 455880704 217.4G 83 Linux

     Partition table entries are not in disk order.
     ```
     {: .code}
This is the output from my laptop. You will see something different when you
do this on a machine in the lab.

1. It is also possible to use `fdisk` with a disk image file, e.g.

     ```sh
     $ fdisk -l test.img
     Disk w12345678/kf4005/test.img: 2.5 GiB, 2684354560 bytes, 5242880 sectors
     Units: sectors of 1 * 512 = 512 bytes
     Sector size (logical/physical): 512 bytes / 512 bytes
     I/O size (minimum/optimal): 512 bytes / 512 bytes
     Disklabel type: dos
     ...
     Device                     Boot   Start     End Sectors  Size Id Type
     w12345678/kf4005/test.img1 *       2048 3145727 3143680  1.5G 83 Linux
     w12345678/kf4005/test.img2      3147774 5240831 2093058 1022M  5 Extended
     w12345678/kf4005/test.img5      3147776 5240831 2093056 1022M 82 Linux swap / Solaris
     ```
     {: .code}
...
the [lecture slides](http://hesabu.net/kf4005/assets/ra/B08.pdf) if you need a reminder about how to do this.
